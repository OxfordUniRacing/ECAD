...
//993209/1050575/2.49/5/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TLV313QDCKRQ1" (originalName "TLV313QDCKRQ1")
	...
	(compDef "TLV313QDCKRQ1" (originalName "TLV313QDCKRQ1") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TLV313QDCKRQ1"))
		...
		(attr "Manufacturer_Part_Number" "TLV313QDCKRQ1")
		(attr "Mouser Part Number" "595-TLV313QDCKRQ1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TLV313QDCKRQ1?qs=j%252B1pi9TdxUax6BuGmY%2Ft0g%3D%3D")
		(attr "Arrow Part Number" "TLV313QDCKRQ1")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tlv313qdckrq1/texas-instruments?region=nac")
		(attr "Mouser Testing Part Number" "")
		(attr "Mouser Testing Price/Stock" "")
		(attr "Description" "Low-Power, Rail-to-Rail In/Out, Op Amp")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tlv313-q1")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "TLV313QDCKRQ1.stp")
