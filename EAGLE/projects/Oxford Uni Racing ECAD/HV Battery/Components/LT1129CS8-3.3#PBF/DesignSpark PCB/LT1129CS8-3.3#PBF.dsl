...
(library Library_1
	...
	(symbolDef "LT1129CS8-3_3_PBF" (originalName "LT1129CS8-3_3_PBF")
	...
	(compDef "LT1129CS8-3.3#PBF" (originalName "LT1129CS8-3.3#PBF") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "SENSE/ADJ") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "5" (pinName "__SHDN") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LT1129CS8-3_3_PBF"))
		...
		(attr "Datasheet Link" "http://cds.linear.com/docs/en/datasheet/112935ff.pdf")
